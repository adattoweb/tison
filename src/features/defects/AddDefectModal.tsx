import { DefectFormSchema, type DefectFormInput } from "@/api/schemas/defect"
...
import { AlignLeftIcon, NotebookPenIcon, PlusIcon, XIcon } from "lucide-react"
import { Controller, useFieldArray, useForm, type SubmitHandler } from "react-hook-form"

interface ModalProps {
   isOpen: boolean
   setIsOpen: React.Dispatch<React.SetStateAction<boolean>>
   /** Якщо модалку відкрито зі сторінки операції, її можна обрати заздалегідь */
   operationId?: number
}

/** ключ активного статусу в STATUS, змініть, якщо у вас він називається інакше */
...
export function AddDefectModal({ isOpen, setIsOpen, operationId }: ModalProps) {
   ...
   const onSubmit: SubmitHandler<DefectFormInput> = data => {
      doCreateDefect(
         {
            title: data.title,
